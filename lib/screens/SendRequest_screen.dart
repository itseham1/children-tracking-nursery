import 'package:app/screens/monitor_screen.dart';
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        body: SizedBox(
          ...
          child: Padding(
            padding:
                EdgeInsets.symmetric(horizontal: 13.0.w, vertical: 0.h),
                      ...
                      () {
                        ...
                        if (addKey.currentState?.validate() == true &&
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => MonitorScreen(
                                ...
                                durationMinutes: _getMinutes(type!),
                              ),
                            ),
                          );
                        } else if (type == null) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Please choose a time period'),
  ...
  Widget bottom(
    ...
    return SizedBox(
      ...
      child: TextButton(
        ...
        child: text(context, key, 13.sp, textColor,
